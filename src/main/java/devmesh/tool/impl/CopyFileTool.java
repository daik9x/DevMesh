...
public final class CopyFileTool implements Tool {
    @Override public String name() { return "CopyFile"; }
    @Override public String description() { return "Copy a file using Java NIO without spawning a shell."; }
